...
if __name__ == "__main__":
    ...
    optimizerD = get_optimizer(USED_OPTIM_NAME, netD, lr=lr)
    #optimizerG = optim.Adam(netG.parameters(), lr=lr, betas=(beta1, 0.999))
    optimizerG = get_optimizer(USED_OPTIM_NAME, netG, lr=lr)

    criterion_ae = nn.MSELoss()
    #optimizerAE = optim.Adam(netAE.parameters(), lr=lr, betas=(beta1, 0.999))
    optimizerAE = get_optimizer(USED_OPTIM_NAME, netAE, lr=lr)
    ...
    save_visualized_image_each_epoch = 10
